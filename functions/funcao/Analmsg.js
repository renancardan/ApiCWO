          ...
          for(let i in PalPreco){
             ...
             if(DigiTamanho === true && AtiTamanho === true){//digitou o tamanho 
                  ...
                  ItensPedido.push({
                      ...
                      Descont:VerMen.Descont?VerMen.Descont:NaN,
                      Descricao:VerMen.Descricao?VerMen.Descricao:[],
                      Foto:VerMen.Foto?VerMen.Foto:[],
                      ItemEspeci:true,
                      Nome:VerMen.Nome?VerMen.Nome:[],
                      Preco:VerMen.Preco,
                      Quant:1,
                      Sessao:SessaoGuar,
                      SubSessao:VerMen.SubSessao?VerMen.SubSessao:"",
